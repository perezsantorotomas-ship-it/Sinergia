...
<html lang="en">
  ...
  <body>
    <div id="root"></div>
    <script>
      // Proxy window to catch who's trying to set fetch
      (function() {
        ...
        try {
          Object.defineProperty(window, 'fetch', {
            ...
            set: function(val) { 
              console.warn('Attempt to overwrite fetch detected from:', new Error().stack);
              // Do nothing, just prevent the crash if it was a property assignment
              // Note: This might still throw if the property is not configurable
            },
            configurable: true
          });
        } catch (e) {
          console.error('Migration notice: window.fetch is read-only. Some library might be trying to polyfill it unnecessarily.', e);
        }
      })();
    </script>
...
{
  "name": "Sinergia: Alianzas B2B",
  "description": "Ecosistema de matching estratégico para pymes y autónomos. Conexión eficiente, segura y asistida por IA para la economía industrial.",
...
View your app in AI Studio: https://ai.studio/apps/90dd077a-d57f-4ead-a1b6-4dad9dc925da
...
export default defineConfig(({mode}) => {
  ...
  return {
    ...
    build: {
      rollupOptions: {
        external: ['node-fetch', 'undici', 'formdata-polyfill'],
      },
    },
    resolve: {
      alias: {
...
# OPENROUTER_API_KEY: API key for the OpenRouter service (used for Sinergia AI).
# Users configure this via the Secrets panel in the AI Studio UI.
OPENROUTER_API_KEY=

# MAILJET_API_KEY: Public API key for Mailjet email service.
MAILJET_API_KEY=
# MAILJET_API_SECRET: Secret API key for Mailjet email service.
MAILJET_API_SECRET=
...
{
  "projectId": "studio-5971040317-bfc04",
  "appId": "1:33248443448:web:a9fe13d53405eddb5c7acd",
  "apiKey": "AIzaSyBdoE-RBgJqefRsd6f8rFASEoO6-Ejq9Yw",
  "authDomain": "studio-5971040317-bfc04.firebaseapp.com",
  "firestoreDatabaseId": "ai-studio-90dd077a-d57f-4ead-a1b6-4dad9dc925da",
  "storageBucket": "studio-5971040317-bfc04.firebasestorage.app",
  "messagingSenderId": "33248443448",
  "measurementId": ""
}
{
  "entities": {
    "User": {
      "title": "User",
      "description": "User profile and company information",
      "type": "object",
      "properties": {
        "id": { "type": "string" },
        "name": { "type": "string" },
        ...
        "aiMatchingEnabled": { "type": "boolean" },
        "autoDeleteMessages": { "type": "boolean" },
        "bio": { "type": "string" },
    ...
    "Agreement": {
      "title": "Agreement",
      "description": "A mutual collaboration agreement between two companies",
      "type": "object",
      "properties": {
        "id": { "type": "string" },
        "partnerIds": { "type": "array", "items": { "type": "string" } },
        "partnerNames": { "type": "array", "items": { "type": "string" } },
        "signedBy": { "type": "array", "items": { "type": "string" } },
        "status": { "type": "string", "enum": ["pending", "signed", "terminated", "expired", "closed", "closing_pending"] },
        "agreementType": { "type": "string", "enum": ["temporary", "permanent"] },
        ...
        "closingRequestedBy": { "type": "string" },
        "willCloseAt": { "type": "string", "format": "date-time" }
      },
      "required": ["id", "partnerIds", "partnerNames", "signedBy", "status", "agreementType", "createdAt"]
    },
    "Notification": {
      "title": "Notification",
      "description": "In-app notification for the user",
      "type": "object",
      "properties": {
        "id": { "type": "string" },
        "userId": { "type": "string" },
      ...
      "required": ["id", "userId", "title", "desc", "read", "createdAt"]
    },
    "Chat": {
      "title": "Chat",
      "description": "A conversation between two companies",
      "type": "object",
      "properties": {
        "id": { "type": "string" },
    ...
    "Review": {
      "title": "Review",
      "description": "A review given by a premium user to a company",
      "type": "object",
      "properties": {
        "id": { "type": "string" },
      ...
      "required": ["id", "reviewerId", "companyId", "rating", "createdAt"]
    }
  },
  "firestore": {
    "/users/{userId}": {
    ...
    "/agreements/{agreementId}": {
      "schema": "Agreement",
      "description": "Signed collaboration agreements"
    },
